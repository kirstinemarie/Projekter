...
<?php
	...
	$pw = filter_input(INPUT_POST, 'pw')
		...
		$pw = password_hash($pw, PASSWORD_DEFAULT); // password-hash er med til at sikre vore password, der bliver lavet en kode algoritme som ændres over tid, som er med til at sikre hackning 
